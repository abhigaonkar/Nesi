...
namespace Nesi.Web.sections.reports.customer_reports
	{
	public partial class PartialBilling : System.Web.UI.Page
		{
		...
		readonly string _page_name = "Partial Billing";
		readonly string _grid_name = "gvPartialBilling";

		protected void Page_Init(object sender, EventArgs e)
			{
			current_user												= Toolbox.do_handle_authentication(OpsPage.PartialBilling);
