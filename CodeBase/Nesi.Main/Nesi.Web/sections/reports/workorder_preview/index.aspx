<%@ Page Language="C#" AutoEventWireup="true" EnableTheming="True" Inherits="sections_reports_workorder_preview_index" Codebehind="index.aspx.cs" %>
...
<head runat="server">
	...
	<title runat="server" id="report_title">Work Order Preview</title>
</head>
<body>
	...
	<form id="form1" runat="server">
			...
			<dx:ReportToolbar ID="ReportToolbar1" runat="server" ClientInstanceName="tb"
				...
				<Items>
					...
					<dx:ReportToolbarButton ImageUrl="/images/icon/icon[email].gif" Name="Email" Text="Email" ToolTip="Email this Work Order Preview" Enabled="True" />
			...
			<dx:ASPxLoadingPanel ID="loadingPanel" runat="server" ClientInstanceName="loadingPanel" Modal="True" Text="Sending Work Order Preview via Email...">
	...
	loadingPanel.Show();
								...
								<td style="width: 50px">
									<dx:ASPxCheckBox runat="server" Wrap="False" Text="BCC to me..."
