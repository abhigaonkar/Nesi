...
public partial class slugging : System.Web.UI.Page
	...
	private const int _page_id = 84; // from Page table in DB
	private const string _page_name = "Slugging";
	...
	protected void Page_Init(object sender, EventArgs e)
		...
		layout.used_gv			= gv_slugging;
		h.Set("gridview_id", "gv_slugging");
	...
	protected void Page_Load(object sender, EventArgs e)
        ...
        if (!IsPostBack)
			...
			if(gl.GridLayoutID == 0)
				{
				gl.GridLayout_Layout		= gv_slugging.SaveClientLayout();
				...
				{
				gv_slugging.LoadClientLayout(gl.GridLayout_Layout);
				h.Set("ID", gl.GridLayoutID);
				h.Set("NAME", gl.GridLayout_Name);
				}
	...
	protected void gv_slugging_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
		{
	...
	protected void gv_slugging_CustomJSProperties(object sender, ASPxGridViewClientJSPropertiesEventArgs e)
		{
		var gv				= (ASPxGridView) sender;
