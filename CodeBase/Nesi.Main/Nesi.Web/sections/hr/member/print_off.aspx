<%@ Page Title="" Language="C#" MasterPageFile="~/nonFrame.master" AutoEventWireup="true" Inherits="sections_hr_member_print_off" Codebehind="print_off.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMasterBody" Runat="Server">
	<dx:ReportToolbar ID="rv_toolbar" runat="server" ReportViewerID="rv" ShowDefaultButtons="False">
		<Items>
