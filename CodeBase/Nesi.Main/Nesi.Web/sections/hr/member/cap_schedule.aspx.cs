...
public partial class sections_hr_member_cap_schedule : System.Web.UI.Page
{
	NeMember current_user;
	private int page_id = 175;
	ASPxHiddenField h;
	SqlDataSource ds_templates;
	ASPxDropDownEdit dde_filter;
	Panel panel_export;
	Toolbox _tools;
	string _page_name = "cap_schedule";
