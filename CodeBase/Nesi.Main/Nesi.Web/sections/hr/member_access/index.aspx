<%@ Page Language="C#" MasterPageFile="~/nonframe.master" AutoEventWireup="true" Inherits="sections_hr_member_access_index" Title="Member Access" Codebehind="index.aspx.cs" %>
            ...
            <table width="100%">
				...
				<table style="font-family:arial;font-size:12px;">
					<tr>
						...
						<td>
							<dx:ASPxComboBox ID="ddl_type" runat="server" AutoPostBack="True" ValueType="System.Int32" onselectedindexchanged="ddl_type_SelectedIndexChanged">
								<Items>
									<dx:ListEditItem Text="Employee" Value="1" />
								</Items>
							</dx:ASPxComboBox>
						</td>
					</tr>
					<tr>
						...
						<td>
							<dx:ASPxComboBox ID="ddl_company" runat="server" IncrementalFilteringMode="Contains" AutoPostBack="True" EnableCallbackMode="True" onselectedindexchanged="ddl_company_SelectedIndexChanged" ValueType="System.Int32">
							</dx:ASPxComboBox>
						</td>
					</tr>
					<tr>
						<td><b>User:</b></td>
						<td>
							<dx:ASPxComboBox ID="ddl_user" runat="server" AutoPostBack="True" onselectedindexchanged="ddl_user_SelectedIndexChanged" ValueType="System.Int32">
							</dx:ASPxComboBox>
						</td>
					</tr>
					<tr>
						<td>
							<asp:SqlDataSource ID="ds_templates" runat="server" 
								...
								SelectCommand="SELECT id,name FROM pageprivilege_template WHERE type = IF(?type = 1 OR ?type = null, 1, 2)">
								<SelectParameters>
									<asp:ControlParameter ControlID="ddl_type" Name="type" PropertyName="Value" />
								</SelectParameters>
							</asp:SqlDataSource>
						</td>
						<td>
							<dx:ASPxButton ID="bt_savetouser" runat="server" onclick="bt_savetouser_Click" 
								Text="Apply Below Changes to Above USER" Visible="False">
				...
				<tr>
					<td align="left">
						<table ID="table_templatemanagement" runat="server" cellpadding="5" 
							cellspacing="0" style="border:solid 1px #000;width:725px;">
							<tr>
