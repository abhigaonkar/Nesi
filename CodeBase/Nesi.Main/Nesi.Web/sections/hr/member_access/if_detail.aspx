<%@ Page Language="C#" MasterPageFile="~/nonframe.master" AutoEventWireup="true" Inherits="sections_hr_member_access_if_detail" Title="Member Access Detail" Codebehind="if_detail.aspx.cs" %>
...
function item_click(obj, e)
							...
							<tr>
								<td>
									<dx:ASPxCheckBox ID="ck_all_active" runat="server" CheckState="Unchecked" 
										ClientInstanceName="ck_all_active" Text="Toggle all active members" 
										Font-Names="Arial">
										<ClientSideEvents CheckedChanged="function(s, e) {
	tree_memlist.PerformCallback(s.GetChecked());
								...
								<td width="0%">
									&nbsp;</td>
								<td>
									<dx:ASPxCheckBox ID="ck_all_enabled" runat="server" CheckState="Unchecked" 
										ClientInstanceName="ck_all_enabled" Text="Toggle all enabled members" 
										Font-Names="Arial">
										<ClientSideEvents CheckedChanged="function(s, e) {
	tree_priv_list.PerformCallback(s.GetChecked());
}" />
									</dx:ASPxCheckBox>
								</td>
							</tr>
							<tr>
								<td class="style1">
									Available Member List (must have login enabled)</td>
							...
							<tr>
								<td rowspan="2" valign="top">
									<dx:ASPxTreeList ID="tree_memlist" runat="server" AutoGenerateColumns="False" ClientInstanceName="tree_memlist" Font-Names="Arial" Font-Size="8pt" Height="100%" OnCustomCallback="tree_CustomCallback" Width="100%">
										<Columns>
											<dx:TreeListTextColumn Caption="Business Unit/Name" FieldName="Business Unit/Name" Name="Business Unit/Name" ShowInCustomizationForm="True" VisibleIndex="0">
												<PropertiesTextEdit EncodeHtml="False">
												</PropertiesTextEdit>
											</dx:TreeListTextColumn>
											<dx:TreeListTextColumn Caption="Member Type" FieldName="MemberType" Name="MemberType" ShowInCustomizationForm="True" VisibleIndex="1">
												<PropertiesTextEdit EncodeHtml="False">
												</PropertiesTextEdit>
											</dx:TreeListTextColumn>
										</Columns>
										<SettingsBehavior FocusNodeOnExpandButtonClick="False" ColumnResizeMode="Control" />
								...
								<td rowspan="2" valign="top">
									<dx:ASPxTreeList ID="tree_priv_list" runat="server" AutoGenerateColumns="False" ClientInstanceName="tree_priv_list" Font-Names="Arial" Font-Size="8pt" Height="100%" OnCustomCallback="tree_CustomCallback" Width="100%">
										<Columns>
											<dx:TreeListTextColumn Caption="Business Unit/Name" FieldName="Business Unit/Name" Name="Business Unit/Name" VisibleIndex="0">
												<PropertiesTextEdit EncodeHtml="False">
												</PropertiesTextEdit>
											</dx:TreeListTextColumn>
											<dx:TreeListTextColumn Caption="Member Type" FieldName="MemberType" Name="MemberType" VisibleIndex="1">
												<PropertiesTextEdit EncodeHtml="False">
												</PropertiesTextEdit>
											</dx:TreeListTextColumn>
										</Columns>
