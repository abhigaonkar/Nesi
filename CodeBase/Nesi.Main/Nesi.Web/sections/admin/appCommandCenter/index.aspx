<%@ Page Title="It Dashboard Settings" Language="C#"  MasterPageFile="~/IntraDefault.master"  AutoEventWireup="true"  EnableTheming="True" Inherits="sections_admin_appCommandCenter_index" Codebehind="index.aspx.cs" %>	
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMasterSubMenu" runat="Server">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server">
        <Items>
            <dx1:LayoutGroup>
                <Items>
                    <dx1:LayoutItem Caption="Topic">
                        <LayoutItemNestedControlCollection>
                            <dx1:LayoutItemNestedControlContainer runat="server">
                                
                                <dx1:ASPxComboBox ID="topics" runat="server">
                                </dx1:ASPxComboBox>
