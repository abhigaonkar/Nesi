...
public partial class sections_customer_modules_files : System.Web.UI.UserControl
	{
	...
	public void init()
		...
		files_frame.Attributes["src"]	= "/filemanager.aspx?parent_page=customer&id="+customer_id+"&address_id="+address_id;
		}
