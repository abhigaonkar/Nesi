...
public partial class cust_qc : Page
	{
    NeMember current_user;
    private const int _page_id = 21; // from Page table in DB
	private const string _page_name = "CustomerQC";
	ASPxHiddenField h;
    ...
    protected void Page_Load(object sender, EventArgs e)
		...
		h.Set("gridview_id", "gv_customerqc");
		...
		if (!IsPostBack)
			...
			if(gl.GridLayoutID == 0)
				...
				{
				gv_customerqc.LoadClientLayout(gl.GridLayout_Layout);
				h.Set("ID", gl.GridLayoutID);
				h.Set("NAME", gl.GridLayout_Name);
				}
	...
	protected void gv_customerqc_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
		{
