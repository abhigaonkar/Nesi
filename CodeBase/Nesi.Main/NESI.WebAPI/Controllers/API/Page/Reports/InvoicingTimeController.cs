...
using bllT = NESI.BLL.Pages.Reports.InvoicingTime;
using dtoT = NESI.DTO.ViewModels.Page.Reports.InvoicingTime;

namespace NESI.WebAPI.Controllers.API.Page.Reports
{
    [PageAuthorizationFilter(192)]
    [RoutePrefix("api/Page/InvoicingTime")]
    public class InvoicingTimeController : EmployeeGridControllerBase<dtoT, bllT>
    {
        public InvoicingTimeController()
        {
            key = "id";
            moduleName = "InvoicingTime";
        }
