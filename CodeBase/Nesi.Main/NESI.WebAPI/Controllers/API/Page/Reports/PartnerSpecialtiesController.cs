...
using bllT = NESI.BLL.Pages.Reports.PartnerSpecialties;
using dtoT = NESI.DTO.ViewModels.Page.Reports.PartnerSpecialties;

namespace NESI.WebAPI.Controllers.API.Page.Reports
{
    [PageAuthorizationFilter(196)]
    [RoutePrefix("api/Page/PartnerSpecialties")]
    public class PartnerSpecialtiesController :  EmployeeGridControllerBase<dtoT, bllT>
    {

        public PartnerSpecialtiesController()
        {
            key = "id";
            moduleName = "PartnerSpecialties";
        }
