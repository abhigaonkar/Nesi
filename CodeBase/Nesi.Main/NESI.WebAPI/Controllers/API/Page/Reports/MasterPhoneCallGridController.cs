...
using bllT = NESI.BLL.Pages.Reports.MasterPhoneCallGrid;
using dtoT = NESI.DTO.ViewModels.Page.Reports.MasterPhoneCallGrid;

namespace NESI.WebAPI.Controllers.API.Page.Reports
{
    [PageAuthorizationFilter(203)]
    [RoutePrefix("api/Page/MasterPhoneCallGrid")]
    public class MasterPhoneCallGridController : EmployeeGridControllerBase<dtoT, bllT>
    {
        public MasterPhoneCallGridController()
        {
            key = "phone_log_id";
            moduleName = "MasterPhoneCallGrid";
        }
