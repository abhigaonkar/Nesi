...
using bllT = NESI.BLL.Pages.Reports.MasterResponsibilitesGrid;
using dtoT = NESI.DTO.ViewModels.Page.Reports.MasterResponsibilitesGrid;

namespace NESI.WebAPI.Controllers.API.Page.Reports
{
    [PageAuthorizationFilter(150)]
    [RoutePrefix("api/Page/MasterResponsibilitesGrid")]
    public class MasterResponsibilitesGridController : EmployeeGridControllerBase<dtoT, bllT>
    {
        public MasterResponsibilitesGridController()
        {
            key = "crid";
            moduleName = "MasterResponsibilitesGrid";
        }
