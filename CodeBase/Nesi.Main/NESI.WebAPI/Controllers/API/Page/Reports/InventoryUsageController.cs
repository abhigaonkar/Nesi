...
using bllT = NESI.BLL.Pages.Reports.InventoryUsage;
using dtoT = NESI.DTO.ViewModels.Page.Reports.InventoryUsage;

namespace NESI.WebAPI.Controllers.API.Page.Reports
{
    [PageAuthorizationFilter(97)]
    [RoutePrefix("api/Page/InventoryUsage")]
    public class InventoryUsageController : EmployeeGridControllerBase<dtoT, bllT>
    {
        public InventoryUsageController()
        {
            key = "master_id";
            moduleName = "InventoryUsage";
        }
