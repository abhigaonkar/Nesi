...
using bllT = NESI.BLL.Pages.Reports.CustStatusHistory;
using dtoT = NESI.DTO.ViewModels.Page.Reports.CustStatusHistory;

namespace NESI.WebAPI.Controllers.API.Page.Reports
{
    [PageAuthorizationFilter(141)]
    [RoutePrefix("api/Page/CustStatusHistory")]
    public class CustStatusHistoryController : EmployeeGridControllerBase<dtoT, bllT>
    {
        public CustStatusHistoryController()
        {
            key = "customer_id";
            moduleName = "CustStatusHistory";
        }
