...
using bllT = NESI.BLL.Pages.Reports.FVRGrid;
using dtoT = NESI.DTO.ViewModels.Page.Reports.FVRGrid;

namespace NESI.WebAPI.Controllers.API.Page.Reports
{
    [PageAuthorizationFilter(188)]
    [RoutePrefix("api/Page/FVRGrid")]
    public class FVRGridController : EmployeeGridControllerBase<dtoT, bllT>
    {
        public FVRGridController()
        {
            key = "id";
            moduleName = "FVRGrid";
        }
