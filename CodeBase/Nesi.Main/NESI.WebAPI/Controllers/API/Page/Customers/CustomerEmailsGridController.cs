...
using bllT = NESI.BLL.Pages.Customers.CustomerEmailsGrid;
using dtoT = NESI.DTO.ViewModels.Page.Customers.CustomerEmailsGrid;

namespace NESI.WebAPI.Controllers.API.Page.Customers
{
	[PageAuthorizationFilter(10)]
	[RoutePrefix("api/Page/CustomerEmailsGrid")]
	public class CustomerEmailsGridController : EmployeeGridControllerBase<dtoT, bllT>
	{
		protected int _customer_id;

		public CustomerEmailsGridController()
		{
			key = "emaillog_id";
		}
