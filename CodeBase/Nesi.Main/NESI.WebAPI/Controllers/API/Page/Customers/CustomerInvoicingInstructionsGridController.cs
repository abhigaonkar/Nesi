...
using bllT = NESI.BLL.Pages.Customers.CustomerInvoicingInstructionsGrid;
using dtoT = NESI.DTO.ViewModels.Page.Customers.CustomerInvoicingInstructionsGrid;

namespace NESI.WebAPI.Controllers.API.Page.Customers
{
	[PageAuthorizationFilter(10)]
	[RoutePrefix("api/Page/CustomerInvoicingInstructionsGrid")]
	public class CustomerInvoicingInstructionsGridController : EmployeeGridControllerBase<dtoT, bllT>
	{
		protected int _customer_id;

		public CustomerInvoicingInstructionsGridController()
		{
			key = "id";
		}
