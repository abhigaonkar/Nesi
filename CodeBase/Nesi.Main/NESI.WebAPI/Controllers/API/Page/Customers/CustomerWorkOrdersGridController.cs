...
using bllT = NESI.BLL.Pages.Customers.CustomerWorkOrdersGrid;
using dtoT = NESI.DTO.ViewModels.Page.Customers.CustomerWorkOrdersGrid;

namespace NESI.WebAPI.Controllers.API.Page.Customers
{
	[PageAuthorizationFilter(10)]
	[RoutePrefix("api/Page/CustomerWorkOrdersGrid")]
	public class CustomerWorkOrdersGridController : EmployeeGridControllerBase<dtoT, bllT>
	{
		protected int _customer_id;
		protected int _address_id;

		public CustomerWorkOrdersGridController()
		{
			key = "woprog_id";
		}
