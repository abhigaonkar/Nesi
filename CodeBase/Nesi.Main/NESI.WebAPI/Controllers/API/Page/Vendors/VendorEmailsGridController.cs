...
using bllT = NESI.BLL.Pages.Vendors.VendorEmailsGrid;
using dtoT = NESI.DTO.ViewModels.Page.Vendors.VendorEmailsGrid;

namespace NESI.WebAPI.Controllers.API.Page.Vendors
{
	[PageAuthorizationFilter(10)]
	[RoutePrefix("api/Page/VendorEmailsGrid")]
	public class VendorEmailsGridController : EmployeeGridControllerBase<dtoT, bllT>
	{
		protected int _vendor_id;

		public VendorEmailsGridController()
		{
			key = "emaillog_id";
		}
