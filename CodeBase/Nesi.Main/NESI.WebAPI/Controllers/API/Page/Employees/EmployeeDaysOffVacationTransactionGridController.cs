...
using bllT = NESI.BLL.Pages.Employees.EmployeeDaysOffVacationTransactionGrid;
using dtoT = NESI.DTO.ViewModels.Page.Employees.EmployeeDaysOffVacationTransactionGrid;
using NESI.WebAPI.Controllers.Base;

namespace NESI.WebAPI.Controllers.API.Page.Employees
{
	[PageAuthorizationFilter(127)]
	[RoutePrefix("api/Page/EmployeeDaysOffVacationTransactionGrid")]
	public class EmployeeDaysOffVacationTransactionGridController : EmployeeGridControllerBase<dtoT, bllT>
	{

		public EmployeeDaysOffVacationTransactionGridController()
		{
			key = "id";
			moduleName = "EmployeeDaysOffVacationTransactionGrid";
		}
