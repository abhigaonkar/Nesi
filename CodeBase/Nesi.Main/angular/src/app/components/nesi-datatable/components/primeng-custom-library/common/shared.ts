import {
    ...
    TemplateRef, OnInit, OnChanges,
    OnDestroy, AfterContentInit, QueryList, SimpleChanges, EmbeddedViewRef
} from '@angular/core';
...
@NgModule({
    ...
    exports: [TemplateWrapper, ColumnHeaderTemplateLoader, ColumnBodyTemplateLoader, ColumnFooterTemplateLoader, ColumnFilterTemplateLoader, TemplateLoader, ColumnEditorTemplateLoader],
    // tslint:disable-next-line:max-line-length
    declarations: [TemplateWrapper, ColumnHeaderTemplateLoader, ColumnBodyTemplateLoader, ColumnFooterTemplateLoader, ColumnFilterTemplateLoader, TemplateLoader, ColumnEditorTemplateLoader]
})
