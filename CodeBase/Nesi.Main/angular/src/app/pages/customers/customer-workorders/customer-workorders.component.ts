...
@Component({
  selector: 'nesi-customer-workorders',
  templateUrl: './customer-workorders.component.html',
  styleUrls: ['./customer-workorders.component.css']
})
export class CustomerWorkordersComponent implements OnInit {
  ...
  loadDetail(refresh_button = false) {
    ...
    if (refresh_button) {
      ...
      this.dt.showReport('CustomerWorkOrdersGrid');
    }
  }
