...
@Component({
  selector: 'nesi-customer-specialties',
  templateUrl: './customer-specialties.component.html',
  styleUrls: ['./customer-specialties.component.css']
})
export class CustomerSpecialtiesComponent extends CustomerFormBase implements OnInit {
  ...
  constructor(
    ...
    super(store, cs);
    super.InitCustomer(
      CONFIG.apiURL.page.customers.edit.specialties
    );
  }
